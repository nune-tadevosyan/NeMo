...
__all__ = ['ConformerConvolution', 'ConformerFeedForward', 'ConformerLayerMamba']


class ConformerLayerMamba(torch.nn.Module, AdapterModuleMixin, AccessMixin):
    ...
    def __init__(
        ...
        super(ConformerLayerMamba, self).__init__()
        ...
        self.mamba_attention = Mamba(d_model=d_model, d_state=16,expand=4)
        # convolution module

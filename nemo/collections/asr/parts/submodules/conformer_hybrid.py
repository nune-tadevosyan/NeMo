...
__all__ = ['ConformerConvolution', 'ConformerFeedForward', 'ConformerHybrid']


class ConformerHybrid(torch.nn.Module, AttentionAdapterModuleMixin, AccessMixin):
    ...
    def __init__(
        ...
        print(d_model)
        super(ConformerHybrid, self).__init__()
        print("hybrid conformer")
        ...
        self.mamba_attention = Mamba(d_model=d_model,expand=1, d_state=16)

...
#from nemo.collections.asr.modules.mamba.mamba_ssm.modules.mamba_simple import Mamba 
# from MambaVision.mambavision.models.mamba_vision import MambaVisionMixer
from nemo.collections.asr.modules.mamba.mamba_ssm.utils.generation import InferenceParams
from nemo.mamba.mamba_ssm.models.mixer_seq_simple import create_ssmblock
__all__ = ['ConformerConvolution', 'ConformerFeedForward', 'ConformerMambaVision']


class ConformerMambaVision(torch.nn.Module, AdapterModuleMixin, AccessMixin):
    ...
    def __init__(
        ...
        super(ConformerMambaVision, self).__init__()
        ...
        ssm_cfg = {"expand": 2.25, "d_state": 32, "d_conv": 4, "layer": "Mamba1"}
    ...
    def forward(self, x, att_mask=None, pos_emb=None, pad_mask=None, cache_last_channel=None, cache_last_time=None):
        ...
        inference_params = InferenceParams(max_seqlen=20, max_batch_size=1,seqlen_offset=5)
        # x = self.mamba_attention(x, inference_params)
        residual =  self.mamba(residual,inference_params)

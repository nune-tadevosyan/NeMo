...
from nemo.collections.asr.parts.submodules.mamba_modules import MambaAttentionLayer
...
class MambaEncoder(NeuralModule, StreamingEncoder, Exportable, AccessMixin):
    ...
    Args:
        ...
        ff_expansion_factor (int): the expansion factor in feed forward layers
            Defaults to 4.
        add_self_attention: Whether to keep hybrid architecture Mamba + SA or only Mamba blocks
    ...
    def __init__(
        ...
        for i in range(n_layers):
            layer = MambaAttentionLayer(
                ...
                add_self_attention=self.add_self_attention,
...
class MambaMultiLayerFeatureExtractor(NeuralModule, Exportable, AccessMixin):
    """
